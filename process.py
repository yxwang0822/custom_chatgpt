...
def create_corpus(text_files_path, corpus_csv):
    ...
    for file in os.listdir(text_files_path):
        ...
        with open(text_files_path + file, "r", encoding="latin1") as f:
            text = f.read()
...
parser.add_argument('text_files_path', type=str,
                    help='Folder with txt files to process. For example: ./text/www.merlos.org')
